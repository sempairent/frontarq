...
export default function LotesVendidos() {
    ...
    useEffect(() => {
        ...
        const fetchProjectName = async () => {
            try {
                ...
                toast.error("error name project")
            }
        };
        fetchProjectName();
    }, [proyectoId]);
    ...
    const fetchLotes = async (page = 1) => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_URL}/vendidos/${proyectoId}?${query}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            const token = localStorage.getItem('token')
            const response = await fetch(`${API_URL}/vendidos/${selectedLote.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const validateForm = () => {
        ...
        if (!newLote.financiado) errors.financiado = 'El Campo es obligatorio';
    ...
    const handleAddLote = async () => {
        ...
        if (newLote.adelanto < 0 || newLote.total < 0) {
        ...
        if (newLote.adelanto !== newLote.total) {
            toast.error('El Adelanto debe ser igual al Total 😞');
            return;
        }

        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`${API_URL}/vendidos`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const handleDownloadExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Lotes_Vendidos");

        // Descargar el archivo
        XLSX.writeFile(wb, "Lotes_Vendidos.xlsx");
    };
            ...
            <FondoPaginas>
                ...
                <CardClientes>
                    ...
                    <div className="container mx-auto">
                        ...
                        <Title>Lotes Vendidos en {projectName || 'cargando...'}</Title>
                                ...
                                {selectedLote && (
                                    <form>
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div>
                                                <label className='block text-sm font-medium'>Mz y Lote</label>
                                                <input
                                                    type="text"
                                                    name="mzYLote"
                                                ...
                                                />
                                                {errors.mzYLote && <p className="text-red-500 text-xs">{errors.mzYLote}</p>}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                />
                                                {errors.adelanto && <p className="text-red-500 text-xs">{errors.adelanto}</p>}
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                />
                                                {errors.asesor && <p className="text-red-500 text-xs">{errors.asesor}</p>}
                                            </div>
                                        </div>
                                        <br />
                                        <div>
                                            ...
                                            />
                                            {errors.financiado && <p className="text-red-500 text-xs">{errors.financiado}</p>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                /* onChange={(e) => {
                                                     ...
                                                     //setNewLote({ ...newLote, adelanto: value });
                                                     setNewLote({ ...newLote, adelanto: value === '' ? '' : parseFloat(value) });
